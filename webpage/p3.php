...
$avg_grade = $_POST['Name'];

$seg_name = mysqli_real_escape_string($conn, $seg_name);
// this is a small attempt to avoid SQL injection
// better to use prepared statements

$query = 'SELECT Type, sum(act.MovingTime)/3600 as total_active_time
FROM activity act
...
$query = $query." AND g.Name='".$avg_grade."'";
$query = $query." group by act.Type";
...
while($row = mysqli_fetch_array($result, MYSQLI_BOTH))
  {
    ...
    print "<td> $row[total_active_time] </td></tr>";
  }
print "</pre>";
