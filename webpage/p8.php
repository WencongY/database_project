...
$query = 'SELECT act.Type, sum(act.MovingTime)/3600 as total_active_hours, sum(act.Distance)/1609 as total_miles, g.Name FROM activity act
...
// $query = $query." AND g.GearId='".$avg_grade."'";
...
while($row = mysqli_fetch_array($result, MYSQLI_BOTH))
  {
    ...
    print "<td> $row[total_active_hours] </td>";
    print "<td> $row[total_miles] </td>";
